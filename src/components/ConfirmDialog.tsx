    ...
    <div className="fixed inset-0 z-[200] bg-white/80 backdrop-blur-sm flex items-center justify-center p-4">
      <div className="bg-white border-2 border-border w-full max-w-sm p-6 space-y-6 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)]">
        ...
        <div className="flex gap-4">
          <button 
            onClick={onConfirm}
            className="flex-1 bg-red-600 text-white border-2 border-border py-3 text-[10px] font-black uppercase tracking-widest hover:bg-red-700 transition-all shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] active:translate-x-[1px] active:translate-y-[1px] active:shadow-none"
          >
            {t('common.confirm')}
          </button>
          <button 
            onClick={onCancel}
            className="flex-1 bg-white text-ink border-2 border-border py-3 text-[10px] font-black uppercase tracking-widest hover:bg-canvas transition-all shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] active:translate-x-[1px] active:translate-y-[1px] active:shadow-none"
          >
            {t('common.cancel')}
          </button>
        </div>
